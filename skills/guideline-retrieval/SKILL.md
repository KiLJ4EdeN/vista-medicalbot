...
Use `search_medical_guidelines` when the user asks about appropriateness,
recommended workup, treatment guidance, criteria, or another question likely
covered by shared clinical guidance.
