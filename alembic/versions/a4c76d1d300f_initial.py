...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'ready', 'failed', name='processingstatus', native_enum=False), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending', 'completed', 'failed', name='messagestatus', native_enum=False), nullable=False),
